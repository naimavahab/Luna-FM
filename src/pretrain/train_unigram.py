# Example:
# python train_rna_unigram.py \
#   --fasta_file final.fasta \
#   --dataset_dir rna_Seqs \
#   --tokenizer_path 4k_unigram_tokeniser \
#   --tokenized_dir tokenised_rna_unigram \
#   --output_dir ./RNA_FM_models_unigram \
#   --save_model_path RNA_FM_models_unigram \
#   --wandb_project RNA_Pretrain \
#   --wandb_name Pretraining_Unigram \
#   --run_name RNA_modernBERT_unigram \
#   --max_len 128 \
#   --num_train_epochs 20 \
...
def parse_args():
    ...
    parser.add_argument("--tokenizer_path", type=str, default="4k_unigram_tokeniser")
    parser.add_argument("--tokenized_dir", type=str, default="tokenised_rna_unigram")
    parser.add_argument("--output_dir", type=str, default="./RNA_FM_models_unigram")
    parser.add_argument("--save_model_path", type=str, default="RNA_FM_models_unigram")
    parser.add_argument("--wandb_project", type=str, default="RNA_Pretrain")
    parser.add_argument("--wandb_name", type=str, default="Pretraining_Unigram")
    parser.add_argument("--run_name", type=str, default="RNA_modernBERT_unigram")
